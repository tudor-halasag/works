...
const CAD_ITEMS = [
  {
    ...
    model: 'Precision Centrifugal Compressor Impeller.glb',
    sub: 'Rotating Machinery · Turbomachinery',
    spec: ['Centrifugal Flow', 'Precision Blading', 'CATIA V6'],
    github: '#',
    live: '#',
  },
  {
    ...
    model: 'TurboFan.glb',
    sub: 'Propulsion System · Aerospace',
    spec: ['Multi-stage', 'High Bypass', 'SolidWorks'],
    github: '#',
    live: '#',
  },
  {
    id: 'C3',
    title: 'Robotic Arm',
    model: 'RoboticArm.glb',
    sub: 'Industrial Robotics · Kinematics',
    spec: ['6-DOF', 'Serial Manipulator', 'CATIA V6'],
    github: '#',
    live: '#',
  },
  {
    ...
    model: 'RoboticArmGripper.glb',
    sub: 'End Effector · Gripping Mechanism',
    spec: ['Parallel Jaw', 'Actuated', 'AutoCAD'],
    github: '#',
    live: '#',
  },
]
...
function CadCard({ item }) {
  const modelSrc = `${import.meta.env.BASE_URL}${item.model}`
  return (
    <div className="cad-card sf">
      ...
      <div className="cad-actions">
        <a href={item.github} className="cad-btn cad-btn-ghost" target="_blank" rel="noopener noreferrer">
        ...
        <a href={item.live} className="cad-btn cad-btn-primary" target="_blank" rel="noopener noreferrer">
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="10,8 16,12 10,16"/></svg>
          Run Online
        </a>
      </div>
    </div>
    ...
    <div className="app">
      ...
      <nav className={`navbar${scrolled ? ' scrolled' : ''}`}>
        <div className="nav-inner">
          ...
          <a href={CV_SITE_URL} className="nav-cv-btn">Back to CV</a>
        ...
        <div className={`mobile-menu${menuOpen ? ' open' : ''}`}>
          ...
          <div className="mobile-inner">
            ...
            <a href={CV_SITE_URL} className="mobile-link mobile-cv-link"
              style={{'--i': NAV_LINKS.length}}>Back to CV</a>
          </div>
        </div>
      </nav>
